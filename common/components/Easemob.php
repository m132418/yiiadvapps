...
//------------------------------------------------------用户体系	
	...
	*/
	function getToken()
	{
		...
		//return $tokenResult;
// 		print_r("Authorization:Bearer ". $tokenResult['access_token']) ; exit() ;
		return "Authorization:Bearer ".$tokenResult['access_token'];
		
		
// 		return "Authorization:Bearer " ."YWMtl7_O_lRxEea7AHF-ep0KTwAAAVdkfeA-51bTAa1rZee_XF-yx9MrehviAPI" ;
...
// 	   $toprint =	$this->getToken() ;
// 		print_r($toprint) ;exit() ;

		$dlog = new DebugLog() ;
		$dlog->key = "easemob_getToken";
		$dlog->debug = ($this->getToken()) ;
		$dlog->save(false) ;
